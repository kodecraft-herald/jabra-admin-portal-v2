...
#[component]
pub fn Icon(title: String, class: String) -> impl IntoView {
    match title.as_str() {
        "Quotes" => view! {
            <span>
        ...
        "Jabra" => view! {
            <svg class={format!("{}", class.clone())} xmlns="http://www.w3.org/2000/svg" width="58" height="58" viewBox="0 0 58 58" fill="currentColor">
